...
new ShortCuts('redo', 'Z', () => undefined, false, true)

new ShortCuts('note', '1', () => ui.note_choice('n'))
new ShortCuts('bumper', '2', () => ui.note_choice('b'))
new ShortCuts('mine', '3', () => ui.note_choice('m'))
new ShortCuts('mine-bumper', '4', () => ui.note_choice('mb'))
new ShortCuts('hold', '5', () => ui.note_choice('h'))
new ShortCuts('s-bumper', '6', () => ui.note_choice('s'))
